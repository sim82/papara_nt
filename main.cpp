...
int main( int argc, char *argv[] ) {
    ...
    if( !opt_use_cgap ) {
        papara_nt<pvec_pgap> pnt( opt_tree_name.c_str(), opt_alignment_name.c_str(), qs_name );
        ...
        papara_nt<pvec_cgap> pnt( opt_tree_name.c_str(), opt_alignment_name.c_str(), qs_name );
